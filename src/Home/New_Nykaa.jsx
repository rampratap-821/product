    ...
    return (
        <div className='w-[100%  mx-auto bg-gradient-to-br from-pink-50 to-rose-300  py-5 mt-5'>
            <div className='w-[95%]  mx-auto  mt-10'>
                <h1 className='text-center text-5xl text-pink-500 font-bold ' style={{ fontFamily: 'Dancing Script, cursive' }}>NEW AT NYKAA</h1>
                <h1 className='text-center text-2xl text-gray-500 font-semibold'>The  latest beaty Arival you,ll town to want</h1>
...

                        {
                            Cosmetic.map((item) =>
                                <div className='text-center  flex justify-center  '>
                                    <div className='  p-7 bg-white m-4 shadow-lg   '>
                                        <img src={item.url} className=" object-cover h-[300px] w-[300px]    " />
                                        <div>
                ...
                <div className='flex justify-center py-10'>
                    <button className='border border-pink-600 text-black font-bold sm:px-[200px] px-[100px] py-2 rounded-2xl hover:bg-pink-600 duration-1000'>View All</button>
                </div>
