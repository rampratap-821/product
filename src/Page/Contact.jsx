          ...
          <div className="bg-white p-10 rounded-3xl shadow-xl border border-gray-200">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center">
                <FaCommentDots className="text-2xl text-black" />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 rounded-xl border border-gray-300 focus:outline-none text-black"
                ...
                <div>
                  <label className="flex items-center gap-2 text-black font-medium mb-2">
                    <MdOutlineLocalPostOffice className="text-black" />
                    Email Address
                  </label>
                  <input
                    type="email"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="6"
                  className="w-full px-5 py-4 rounded-xl border border-gray-300 focus:outline-none resize-none text-black"
              ...
              <button
                type="submit"
                className="w-full bg-pink-700 text-white py-4 rounded-xl font-bold text-lg hover:bg-pink-800 transition flex items-center justify-center gap-3"
              >
                <FaPaperPlane />
                Send Message
              </button>
          ...
          <div className="space-y-12">
              ...
              <div className="flex justify-center gap-6 mb-8">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href="#"
                    className="w-14 h-14 rounded-full bg-black flex items-center justify-center text-2xl text-white hover:bg-gray-800 transition"
                    title={social.label}
                  >
                    {social.icon}
                  </a>
            ...
            <div>
              <h3 className="text-2xl font-bold text-black mb-8 flex items-center gap-3">
                <span className="text-black">✨</span> Frequently Asked Questions
              </h3>
                ...
                {faqs.map((faq, index) => (
                  ...
                  >
                    <h4 className="text-lg font-semibold text-black mb-3 flex items-center gap-2">
                      <span className="text-black">•</span> {faq.question}
                    </h4>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="h-64 bg-gray-100 rounded-xl flex items-center justify-center border border-gray-300">
                <div className="text-center">
                  <FaMapMarkerAlt className="text-4xl text-black mx-auto mb-4" />
